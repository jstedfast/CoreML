...
namespace CoreML.Specification {
  ...
  public sealed partial class CategoricalMapping : pb::IMessage<CategoricalMapping> {
    ...
    public void MergeFrom(CategoricalMapping other) {
      ...
      switch (other.MappingTypeCase) {
        case MappingTypeOneofCase.StringToInt64Map:
          if (StringToInt64Map == null) {
            StringToInt64Map = new global::CoreML.Specification.StringToInt64Map();
          }
          StringToInt64Map.MergeFrom(other.StringToInt64Map);
          break;
        case MappingTypeOneofCase.Int64ToStringMap:
          if (Int64ToStringMap == null) {
            Int64ToStringMap = new global::CoreML.Specification.Int64ToStringMap();
          }
          Int64ToStringMap.MergeFrom(other.Int64ToStringMap);
          break;
      }
