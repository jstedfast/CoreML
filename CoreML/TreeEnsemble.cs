...
namespace CoreML.Specification {
    ...
    public static partial class Types {
      public sealed partial class TreeNode : pb::IMessage<TreeNode> {
        ...
        public bool Equals(TreeNode other) {
          ...
          if (BranchFeatureValue != other.BranchFeatureValue) return false;
          ...
          if (RelativeHitRate != other.RelativeHitRate) return false;
          return true;
        }
        ...
        public override int GetHashCode() {
          ...
          if (BranchFeatureValue != 0D) hash ^= BranchFeatureValue.GetHashCode();
          ...
          if (RelativeHitRate != 0D) hash ^= RelativeHitRate.GetHashCode();
          return hash;
        }
        ...
        public static partial class Types {
          ...
          public sealed partial class EvaluationInfo : pb::IMessage<EvaluationInfo> {
            ...
            public override int GetHashCode() {
              ...
              if (EvaluationValue != 0D) hash ^= EvaluationValue.GetHashCode();
              return hash;
            }
  ...
  public sealed partial class TreeEnsembleClassifier : pb::IMessage<TreeEnsembleClassifier> {
    ...
    public TreeEnsembleClassifier(TreeEnsembleClassifier other) : this() {
      TreeEnsemble = other.treeEnsemble_ != null ? other.TreeEnsemble.Clone() : null;
