...
namespace CoreML.Specification {
      ...
      switch (other.KernelCase) {
        case KernelOneofCase.LinearKernel:
          if (LinearKernel == null) {
            LinearKernel = new global::CoreML.Specification.LinearKernel();
          }
          LinearKernel.MergeFrom(other.LinearKernel);
          break;
        case KernelOneofCase.RbfKernel:
          if (RbfKernel == null) {
            RbfKernel = new global::CoreML.Specification.RBFKernel();
          }
          RbfKernel.MergeFrom(other.RbfKernel);
          break;
        case KernelOneofCase.PolyKernel:
          if (PolyKernel == null) {
            PolyKernel = new global::CoreML.Specification.PolyKernel();
          }
          PolyKernel.MergeFrom(other.PolyKernel);
          break;
        case KernelOneofCase.SigmoidKernel:
          if (SigmoidKernel == null) {
            SigmoidKernel = new global::CoreML.Specification.SigmoidKernel();
          }
          SigmoidKernel.MergeFrom(other.SigmoidKernel);
          break;
      }
  ...
  public sealed partial class SupportVectorRegressor : pb::IMessage<SupportVectorRegressor> {
    ...
    public SupportVectorRegressor(SupportVectorRegressor other) : this() {
      kernel_ = other.kernel_ != null ? other.kernel_.Clone() : null;
    ...
    public void MergeFrom(SupportVectorRegressor other) {
      ...
      switch (other.SupportVectorsCase) {
        case SupportVectorsOneofCase.SparseSupportVectors:
          if (SparseSupportVectors == null) {
            SparseSupportVectors = new global::CoreML.Specification.SparseSupportVectors();
          }
          SparseSupportVectors.MergeFrom(other.SparseSupportVectors);
          break;
        case SupportVectorsOneofCase.DenseSupportVectors:
          if (DenseSupportVectors == null) {
            DenseSupportVectors = new global::CoreML.Specification.DenseSupportVectors();
          }
          DenseSupportVectors.MergeFrom(other.DenseSupportVectors);
          break;
      }
