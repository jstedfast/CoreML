...
namespace CoreML.Specification {
  ...
  public sealed partial class Imputer : pb::IMessage<Imputer> {
    ...
    public bool Equals(Imputer other) {
      ...
      if (!pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.Equals(ImputedDoubleValue, other.ImputedDoubleValue)) return false;
      ...
      if (!pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.Equals(ReplaceDoubleValue, other.ReplaceDoubleValue)) return false;
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (imputedValueCase_ == ImputedValueOneofCase.ImputedDoubleValue) hash ^= pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.GetHashCode(ImputedDoubleValue);
      ...
      if (replaceValueCase_ == ReplaceValueOneofCase.ReplaceDoubleValue) hash ^= pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.GetHashCode(ReplaceDoubleValue);
    ...
    public void MergeFrom(Imputer other) {
      ...
      switch (other.ImputedValueCase) {
        ...
        case ImputedValueOneofCase.ImputedStringValue:
          ...
          break;
        case ImputedValueOneofCase.ImputedDoubleArray:
          if (ImputedDoubleArray == null) {
            ImputedDoubleArray = new global::CoreML.Specification.DoubleVector();
          }
          ImputedDoubleArray.MergeFrom(other.ImputedDoubleArray);
          break;
        case ImputedValueOneofCase.ImputedInt64Array:
          if (ImputedInt64Array == null) {
            ImputedInt64Array = new global::CoreML.Specification.Int64Vector();
          }
          ImputedInt64Array.MergeFrom(other.ImputedInt64Array);
          break;
        case ImputedValueOneofCase.ImputedStringDictionary:
          if (ImputedStringDictionary == null) {
            ImputedStringDictionary = new global::CoreML.Specification.StringToDoubleMap();
          }
          ImputedStringDictionary.MergeFrom(other.ImputedStringDictionary);
          break;
        case ImputedValueOneofCase.ImputedInt64Dictionary:
          if (ImputedInt64Dictionary == null) {
            ImputedInt64Dictionary = new global::CoreML.Specification.Int64ToDoubleMap();
          }
          ImputedInt64Dictionary.MergeFrom(other.ImputedInt64Dictionary);
          break;
      }
